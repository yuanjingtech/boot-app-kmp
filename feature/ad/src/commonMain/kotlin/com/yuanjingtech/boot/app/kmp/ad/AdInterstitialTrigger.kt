...
@Preview(name = "AdInterstitialTrigger per config", group = "feature/ad - variants")
@Composable
@PreviewWrapper(wrapper = AdLightPreviewWrapper::class)
private fun AdInterstitialTriggerPerConfigPreview(
    ...
    KoinApplicationPreview(application = { modules(adModule) }) {
        ...
        Surface(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                AdInterstitialTrigger(config = config, trigger = counter)
            }
        }
    }
}
